...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>S.S. Soft</b></a>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/me.jpg" width=100 height=100 alt="Muhammed Garba" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		...
		<h4 style="font-family:'typo' ">Ahmadu Bello Universety, Zaria</h4></div></div>
		</p>
      </div>
